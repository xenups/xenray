...
class TestStaticRouteFiltering:
    ...
    def test_add_static_route_skips_private_ip(self, service):
        ...
        with patch("src.services.singbox_service.subprocess.run") as mock_run:
    ...
    def test_start_bypass_targets_restricted_to_proxy_server(self):
        ...
        with (
            ...
            patch.object(service, "_suppress_smhr"),
            ...
            patch.object(service, "_resolve_ips", return_value=["104.17.121.70"]) as mock_resolve,
            patch.object(service, "_add_static_route") as mock_route,
        ):
            service.start(
