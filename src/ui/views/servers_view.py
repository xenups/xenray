...
class ServersView(ft.Container):
    ...
    def __init__(
        ...
        self._search_field = ft.TextField(
            hint_text=t("servers.search_placeholder", default="Search server name, region or IP..."),
                        ...
                        [
                            ...
                            ft.Column(
                                [
                                    ...
                                    ft.Row(
                                        [
                                            ft.Icon(ft.Icons.WIFI, size=14, color=ft.Colors.WHITE),
                                            self._hero_node_protocol,
                                            ft.Icon(ft.Icons.LAN, size=14, color=ft.Colors.WHITE),
    ...
    def update_hero_node(self, name: str, latency: str, protocol: str = "", speed: str = "", country_code: str = ""):
        """Update top featured node info."""
        self._hero_node_name.value = name or "--"
        self._hero_node_latency.value = latency if latency and latency != "-- ms" else "--"
        self._hero_node_protocol.value = protocol or "--"
        self._hero_node_speed.value = speed or "--"
        self._hero_badge.content.value = t("servers.selected_node", default="SELECTED NODE")
        if country_code:
