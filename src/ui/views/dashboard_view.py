...
class DashboardView(ft.Container):
    ...
    def __init__(
        ...
        self._dl_value_text = ft.Text("D: 0.0 MB/s", size=12, weight=ft.FontWeight.W_600, color=WHITE)
        self._ul_value_text = ft.Text("U: 0.0 MB/s", size=12, weight=ft.FontWeight.W_600, color=WHITE)

        self._data_stats_column = ft.Column(
            [
                ft.Row(
                    [
                        ft.Icon(ft.Icons.SOUTH_WEST_ROUNDED, size=13, color=MUTED_WHITE),
                        self._dl_value_text,
                    ],
                    spacing=4,
                ...
                ft.Row(
                    [
                        ft.Icon(ft.Icons.NORTH_EAST_ROUNDED, size=13, color=MUTED_WHITE),
                        self._ul_value_text,
                    ],
                    spacing=4,
                    alignment=ft.MainAxisAlignment.END,
            ...
            [
                ft.Row(
                    [
                        ...
                        ft.Text(
                            t("dashboard.realtime_wave", default="Live Wave Stream & Detailed Traffic Stats"),
                            size=11,
                            color=MUTED_WHITE,
                        ),
                    ],
                ...
                ft.Container(
                    content=ft.Row(
                        [
                            ft.Icon(ft.Icons.BAR_CHART_ROUNDED, size=14, color="#c084fc"),
                            ft.Text(
                                t("dashboard.view_statistics", default="Statistics Page 📊"),
                                size=12,
                                weight=ft.FontWeight.W_700,
                                color=WHITE,
                            ),
                    ...
                    on_click=lambda e: self._on_open_statistics_click(e) if self._on_open_statistics_click else None,
                    ink=True,
                ),
            ],
            alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
    ...
    def update_network_stats(
        ...
        # Real Network Statistics Chart update
        ...
        if hasattr(self, "_dl_bars") and self._dl_bars:
            dl_heights = self._compute_smooth_wave_heights(self._dl_history, num_output=len(self._dl_bars), min_h=4.0, max_h=95.0)
            ul_heights = self._compute_smooth_wave_heights(self._ul_history, num_output=len(self._dl_bars), min_h=4.0, max_h=95.0)
