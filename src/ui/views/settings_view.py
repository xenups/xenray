        ...
        if self._on_open_routing_click:
            routing_controls.append(
                SettingsListTile(
                    ...
                    t("settings.routing_description", default="Configure custom domain and IP routing rules"),
        ...
        if self._on_open_dns_click:
            routing_controls.append(
                SettingsListTile(
                    ...
                    t("settings.dns_description", default="Configure custom DNS servers and resolution strategies"),
        ...
        self._update_card = create_glass_container(
            content=ft.Row(
                [
                    ft.Column(
                        [
                            ft.Text("XenRay Client", size=14, weight=ft.FontWeight.W_700, color=WHITE),
                            ft.Text(
                                t("settings.version", default="v1.0.0"), size=12, color=AppColors.ON_SURFACE_VARIANT
                            ),
                        ],
                        spacing=2,
                    ),
