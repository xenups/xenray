...
class NodeCardComponent:
    ...
    def __init__(self, on_change_server_click: Callable):
        ...
        # Circular Server Icon Container
        ...
        # Full-width Bottom Change Server Button matching screenshot
        ...
        content = ft.Column(
            [
                ...
                # Server Header with Circular Icon, Name, and Latency Pill
                ft.Row(
                    [
                ...
                # Metadata Grid matching screenshot order (Country, Protocol, Encryption, Server IP)
                ft.Column(
                    [
                        detail_row(t("dashboard.country", default="Country"), self._country_value_row),
                        detail_row(t("dashboard.protocol", default="Protocol"), self._server_protocol_text),
                        detail_row(t("dashboard.encryption", default="Encryption"), self._encryption_text),
                        detail_row(t("dashboard.server_ip", default="Server IP"), self._server_ip_text),
                    ],
                    spacing=4,
                ),
                # Full Width Change Server Button at bottom
