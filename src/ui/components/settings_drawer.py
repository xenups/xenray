                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Text(
                                "Developed by Xenups", size=14, color=ft.colors.PRIMARY
                            ),
                            ft.Text(
                                "A modern, lightweight Xray client.",
                                size=12,
                ...
                ft.Container(
                    content=ft.Row(
                        [
                            ...
                            ft.Text(
                                "Xray", size=12, color=ft.colors.ON_SURFACE_VARIANT
                            ),
                            ...
                            ft.Text(
                                "Tun2Proxy", size=12, color=ft.colors.ON_SURFACE_VARIANT
                            ),
                        ],
                        alignment=ft.MainAxisAlignment.CENTER,
                    ),
