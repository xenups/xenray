...
class SettingsDrawer(ft.NavigationDrawer):
            ...
            controls=[
                ...
                ft.Container(
                    content=ft.Row(
                        [
                            ft.Text(
                                "Direct Country", size=14, weight=ft.FontWeight.W_500
                            ),
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ft.Text(
                                "XenRay v1.0.0", size=14, weight=ft.FontWeight.BOLD
                            ),
    ...
    def _save_country(self, e):
        ...
        # --- FIX: Using page.open() ---
        page.open(ft.SnackBar(content=ft.Text(f"Direct Country saved to: {val} 🌐")))
        page.update()
    ...
    def _save_dns(self, e):
        ...
        # --- FIX: Using page.open() ---
        page.open(ft.SnackBar(content=ft.Text("Custom DNS saved successfully. ✅")))
        page.update()
