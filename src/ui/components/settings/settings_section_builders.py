                ...
                [
                    ...
                    ft.Column(
                        [
                            ...
                            ft.Text(
                                t(
                                    "settings.mode_description",
                                    default="Toggle between TUN/VPN and System Proxy",
                                ),
                                size=12,
                                color=ft.Colors.ON_SURFACE_VARIANT,
                            ),
            ...
            content=ft.Row(
                [
                    ...
                    ft.Column(
                        [
                            ft.Text(
                                t("settings.language", default="Application Language"),
                                size=14,
                                weight=ft.FontWeight.W_600,
                                color=ft.Colors.WHITE,
                            ),
                ...
                [
                    ...
                    ft.Column(
                        [
                            ...
                            ft.Text(
                                t(
                                    "settings.add_to_startup_desc",
                                    default="Launch application automatically at startup",
                                ),
                                size=12,
                                color=ft.Colors.ON_SURFACE_VARIANT,
                            ),
